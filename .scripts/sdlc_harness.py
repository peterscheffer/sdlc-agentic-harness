...
def main():
    ...
    print("  python3 .scripts/sdlc_harness.py status")
    print("  python3 .scripts/sdlc_harness.py reset [--force]")
    print("  python3 .scripts/sdlc_harness.py stage --stage <stage> [--feature <intent>] [--force] [--context <file>] [--autopilot]")
    print("")
