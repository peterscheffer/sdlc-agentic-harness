...
def _classify_solution(state: SDLCPersistedState, config: SDLCConfig):
    ...
    try:
        ...
        prompt = (
            ...
            "var-spec = plain-Markdown executable specs, an alternative to gherkin-bdd for "
            "the same kind of flows, but newer and less proven — only recommend it if the "
            "PRD explicitly asks for Vár or Markdown-as-tests; default to gherkin-bdd otherwise; "
            ...
            "gherkin-bdd + openapi-contract + unit-tests). Never recommend both "
            "gherkin-bdd and var-spec together — they cover the same scenarios.\n\n"
